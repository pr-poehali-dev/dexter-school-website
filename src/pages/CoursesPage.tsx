...
const courses: CourseProps[] = [
  ...
  },
  {
    ...
    description: "Полный курс геометрии для средней школы. Планиметрия, стереометрия, доказательства теорем.",
    level: "intermediate",
    price: 6900,
    duration: "4 месяца",
    image: "https://images.unsplash.com/photo-1509228468518-180dd4864904?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80"
  },
  {
    id: "5",
    title: "Подготовка к ЕГЭ по математике (профиль)",
    description: "Полная подготовка к профильному ЕГЭ по математике. Разбор всех типов заданий, стратегии решения.",
    level: "advanced",
    price: 12900,
    duration: "9 месяцев",
  ...
  },
  {
    ...
    description: "Курс математики для учеников 1-4 классов. Основы арифметики, решение текстовых задач, геометрических фигур.",
    level: "beginner",
    price: 4900,
    duration: "4 месяца",
    image: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1122&q=80"
  }
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8 grid gap-4 md:grid-cols-3">
            <div className="md:col-span-2">
              <Label htmlFor="search" className="mb-2 block">Поиск курсов</Label>
              <Input
                id="search"
            ...
            <div>
              <Label htmlFor="level" className="mb-2 block">Уровень сложности</Label>
