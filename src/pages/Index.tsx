...
const features = [
  {
    ...
    description:
      "Каждый ученик получает персональное внимание и учебный план, адаптированный под его потребности.",
  },
  {
    icon: <Users className="h-10 w-10 text-primary" />,
    title: "Опытные преподаватели",
    description:
      "Наши учителя имеют многолетний опыт преподавания и научные степени в области математики.",
  },
  {
    icon: <Target className="h-10 w-10 text-primary" />,
    title: "Уникальная методика",
    description:
      "Мы используем проверенную методику, которая делает изучение математики интересным и эффективным.",
  },
  {
    icon: <Trophy className="h-10 w-10 text-primary" />,
    title: "Гарантия результата",
    description:
      "Наши ученики показывают высокие результаты на экзаменах и олимпиадах по математике.",
  },
];
